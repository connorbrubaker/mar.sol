...
\begin{document}
    ...
    \begin{enumerate}[(a)]
        \item Use the code below to find a 95\% confidence interval for the slope $\beta_1$.
        \lstinputlisting[linerange={6-11}]{R/2.1_playbill.R}
        As we see from the output, the desired confidence interval is $(0.9515, 1.0127)$. Since the value $1$ is included in this interval, we can say $1$ is a plausible value for the slope $\beta_1$.
